...
# --------------------------------------------------------------------
# Check if all specified nfs/cifs mounts exist and if they are correct implemented.
...
function usage() {
	...
	echo " -N NUMBER   FS Field number in fstab"
	echo " -M NUMBER   Mount Field number in fstab"
